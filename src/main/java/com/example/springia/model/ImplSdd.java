...
@NoArgsConstructor
@Builder
@Entity(name = "lictb010_implementacao_sdd")
public class ImplSdd {

    @Id
    @SequenceGenerator(name = "licsq010_implementacao_sdd", sequenceName = "licsq010_implementacao_sdd", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "licsq010_implementacao_sdd")
    @Column(name = "nu_implementacao_sdd", nullable = false)
    private Long id;
    ...
    @NotBlank
    @Lob
    @Column(name = "de_implementacao", nullable = false, columnDefinition = "TEXT")
